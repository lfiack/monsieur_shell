...
#define SHELL_PRINT_BUFFER_SIZE 40             /**< Size of the print buffer used for output. */
#define SHELL_CMD_BUFFER_SIZE 40               /**< Size of the command buffer used for input. */
...
{
    char c;                             /**< The character trigger for the command. */
